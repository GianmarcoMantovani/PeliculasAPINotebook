...
namespace PeliculasAPI.Migrations
{
    ...
    [Migration("20211229111253_ModeradorData")]
    partial class ModeradorData
    {
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Nombre = "Cine Saladillo",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-59.780257 -35.639151)")
                        },
                        new
                        {
                            Id = 6,
                            Nombre = "Cinemark Hoyts Abasto",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-58.411507 -34.603365)")
                        },
                        new
                        {
                            Id = 7,
